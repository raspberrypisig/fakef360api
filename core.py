...
class FutureStates():
    ...
    def __init__(self):
        pass
    ProcessingFutureState = 0
    FinishedFutureState = 1
    FailedFutureState = 2
...
class ScriptSourceLocations():
    """
    Defines the different locations where Fusion looks for scripts and add-ins.
    """
    def __init__(self):
        pass
    AppStoreScriptSourceLocation = 0
    OtherInstalledScriptSourceLocation = 1
    UserDefinedScriptSourceLocation = 2
    InternalScriptSourceLocation = 3
    SamplesScriptSourceLocation = 4
    LinkedScriptSourceLocation = 5
...
class ApplicationFolders(Base):
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> ApplicationFolders:
        return ApplicationFolders()
    @property
...
class Camera(Base):
    ...
    def isSmoothTransition(self) -> bool:
        """
        Determines whether Fusion does a smooth transition to this camera position when the
...
class Command(Base):
    ...
    def beginStep(self, makeExistingStepNonUndoable: bool = False) -> bool:
        ...
        """
        return bool()
    def setDialogSize(self, width: int, height: int) -> bool:
        """
        ...
        width : The width of the dialog in pixels.
        height : The height of the dialog in pixels. If zero, the dialog will be sized to fit the command inputs currently displayed.
        Returns true if size was successfully set.
        """
        return bool()
    @property
    ...
    def preSelectStart(self) -> SelectionEvent:
        ...
        return SelectionEvent()
    @property
    def hasDistinctSelectionSets(self) -> bool:
        """
        !!!!! Warning !!!!!
        ! This is in preview state; please see the help for more info
        !!!!! Warning !!!!!
        ...
        """
        return bool()
    @hasDistinctSelectionSets.setter
    def hasDistinctSelectionSets(self, value: bool):
        """
        !!!!! Warning !!!!!
        ! This is in preview state; please see the help for more info
        !!!!! Warning !!!!!
...
class CommandDefinition(Base):
    ...
    def execute(self, input: NamedValues = None) -> bool:
        ...
        input : This argument is ignored and exists for possible future use.
...
class CommandDefinitions(Base):
    ...
    def addButtonDefinition(self, id: str, name: str, tooltip: str, resourceFolder: str = "") -> CommandDefinition:
        ...
        file and a portion of the path is common you can remove that portion and replace it with the ellipsis character
        to indicate there is some missing text. There is a single UNICODE character you can use the ellipsis. It is '\u2026'.
        resourceFolder : This argument defines the resource folder that contains the images used for the icon. Icons can be
    ...
    def addListDefinition(self, id: str, name: str, listControlDisplayType: ListControlDisplayTypes, resourceFolder: str = "") -> CommandDefinition:
        ...
        resourceFolder : This argument defines the resource folder that contains the images used as the icond for items in the list.
        Icons can be defined using either PNG or SVG files. More information about icons can be found
        in the user manual topic <a href="UserInterface_UM.htm#IconsForCommands">User Interface Customization</a>.
...
class CommandInputs(Base):
    ...
    def addBoolValueInput(self, id: str, name: str, isCheckBox: bool, resourceFolder: str = "", initialValue: bool = False) -> BoolValueCommandInput:
        ...
        resourceFolder : Specifies the folder that contains the icon for the input.
    ...
    def addDirectionCommandInput(self, id: str, name: str, resourceFolder: str = "") -> DirectionCommandInput:
        ...
        id : The unique ID of this command input. It must be unique with respect to the other inputs associated with this command.
        name : The displayed name of this command as seen in the dialog.
        resourceFolder : Specifies the folder that contains the icon to use for the input.
    ...
    def addSeparatorCommandInput(self, id: str) -> SeparatorCommandInput:
        """
        ...
        id : The unique ID of this command input. It must be unique with respect to the other inputs associated with this command.
        Returns the created SeparatorCommandInput object or null if the creation failed.
        """
        return SeparatorCommandInput()
    @property
...
class Data(Base):
    ...
    def findFileById(self, id: str) -> DataFile:
        ...
        """
        return DataFile()
    def findFolderById(self, id: str) -> DataFolder:
        """
        ...
        id : The full id of the folder will be something similar to that shown below.
        
        urn:adsk.wipprod:fs.folder:co.BdMZ64GqTAie4w3NShw23C
        
        This is also the same id that you'll obtain if you use the APS Data Management API.
        Returns a DataFolder if one is found matching the input id or null if one is not found or you don't
        have privileges to access it.
        """
        return DataFolder()
    @property
...
class DataFile(Base):
    ...
    def refresh(self, handler: DataEventHandler) -> bool:
        ...
        """
        return bool()
    def createMilestone(self, milestoneName: str) -> Milestone:
        """
        Makes the version this DataFile represents a milestone.
        milestoneName : The name of the milestone as seen in the data panel and Fusion web client. If an empty string
        is provided, a default name will be used.
        Returns the created Milestone object or null in the case of failure. One case of failure is
        if a milestone already exists for this version.
        """
        return Milestone()
    def createCopyDesignFileInput(self, folder: DataFolder) -> CopyDesignFileInput:
        """
        !!!!! Warning !!!!!
        ! This is in preview state; please see the help for more info
        !!!!! Warning !!!!!
        ...
        folder : The folder where the copied files will be created.
        Returns the created CopyDesignFileInput object or null in the case of failure.
        """
        return CopyDesignFileInput()
    def createCopyFileInput(self, folder: DataFolder) -> CopyFileInput:
        """
        !!!!! Warning !!!!!
        ! This is in preview state; please see the help for more info
        !!!!! Warning !!!!!
        ...
        folder : The folder where the copied file will be created.
        Returns the created CopyFileInput object or null in the case of failure.
        """
        return CopyFileInput()
    def copyWithInput(self, input: CopyFileInput) -> DataFileFuture:
        """
        !!!!! Warning !!!!!
        ! This is in preview state; please see the help for more info
        !!!!! Warning !!!!!
        ...
        input : The input object is of CopyFileInput object type, based on which our copy behavior will be defined. A
        CopyDesignFileInput object is created using the DataFile.createCopyDesignFileInput.
        The copy process is asynchronous which means that this method
    ...
    def isConfiguredDesign(self) -> bool:
        ...
        return bool()
    @property
    def configurationTable(self) -> Base:
        """
        !!!!! Warning !!!!!
        ! This is in preview state; please see the help for more info
        !!!!! Warning !!!!!
    ...
    def isMilestone(self) -> bool:
        ...
        return bool()
    @property
    def sharedLink(self) -> SharedLink:
        """
    ...
    def fusionWebURL(self) -> str:
        ...
        return str()
    @property
    def dataObject(self) -> DataObjectFuture:
        """
...
class DataObject(Base):
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> DataObject:
        return DataObject()
    def getAsBase64String(self) -> str:
        """
        Gets the binary data represented by the DataObject as a Base64 encoded string.
        Returns the binary data represented by the DataObject as a standard Base64 encoded string. Fails
    ...
    def asString(self) -> str:
        ...
        Returns the data as a standard (UTF-8) string. Fails with an appropriate error in the case where
    ...
    def saveToFile(self, filename: str) -> bool:
        ...
        filename : The full filename to save the file to. This includes the full path and the filename.
...
class Document(Base):
    ...
    def save(self, description: str) -> bool:
        ...
        Returns true if saving the document was successful. This will also return true
    ...
    def updateAllReferences(self) -> bool:
        ...
        """
        return bool()
    def saveMilestone(self, milestoneName: str, versionDescription: str) -> bool:
        """
...
class GeneralPreferences(Base):
    ...
    def panZoomOrbitShortcuts(self, value: PanZoomOrbitShortcuts):
        ...
        pass
    @property
    def isHangDetectionEnabled(self) -> bool:
        """
        ...
        """
        return bool()
    @isHangDetectionEnabled.setter
    def isHangDetectionEnabled(self, value: bool):
        """
        Gets and sets whether hang detection is enabled. This is a Windows only setting.
        If True, Fusion will detect when a task processes for longer than a specific time.
        A dialog is displayed if a hang is detected, allowing the user to continue processing
        ...
        pass
    @property
    def userInterfaceTheme(self) -> UserInterfaceThemes:
        """
        Gets and sets which color theme is used by the user interface.
        """
        return UserInterfaceThemes()
    @userInterfaceTheme.setter
    def userInterfaceTheme(self, value: UserInterfaceThemes):
        """
        Gets and sets which color theme is used by the user interface.
        """
        pass
...
class HttpEventHandler(EventHandler):
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> HttpEventHandler:
        return HttpEventHandler()
    def notify(self, eventArgs: HttpEventArgs) -> None:
        """
        The function called by Fusion when the associated event is fired.
        eventArgs : Returns an object that provides access to additional information associated with the event.
        """
...
class HttpRequest(Base):
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> HttpRequest:
        return HttpRequest()
    @staticmethod
    def create(url: str, method: HttpMethods = HttpMethods.GetMethod) -> HttpRequest:
        """
        Creates a new HttpRequest object.
        url : The URL to make the request to.
        method : The method to use for the request. The default is GetMethod.
        Returns the new HttpRequest object.
        """
        return HttpRequest()
    def setHeader(self, name: str, value: str) -> bool:
        """
        Sets a header for the request.
        name : The name of the header value.
        value : The header's value.
        Returns true if setting the header succeeds.
        """
        return bool()
    def getHeader(self, name: str) -> str:
        ...
        Returns the value of the header, or empty if the header was not found.
    ...
    def hasHeader(self, name: str) -> bool:
        ...
        """
        return bool()
    def removeHeader(self, name: str) -> bool:
        """
        ...
        """
        return bool()
    def headers(self) -> tuple[bool, list[str], list[str]]:
        """
        Get the request headers.
        names : An array of all the header key names.
        values : An array of all the header values.
    ...
    def execute(self) -> bool:
        ...
        Returns true if the request was successfully started.
        """
        return bool()
    def executeSync(self) -> HttpResponse:
        """
        Execute this request synchronously. This will block the thread until the request completes.
        Returns the response from making this request, or null if an error prevents the request from starting.
        """
        return HttpResponse()
    @property
    def url(self) -> str:
    ...
    def method(self) -> HttpMethods:
        ...
        return HttpMethods()
    @method.setter
    def method(self, value: HttpMethods):
        """
        Gets and sets the method to use for the request.
        """
        pass
...
class HttpResponse(Base):
    ...
    def hasHeader(self, name: str) -> bool:
        ...
        the case where a header is not set and the case where a header is set to an empty string.
        name : The case insensitive name of the header.
        True if a header with this name was set in the response.
        """
        return bool()
    def headers(self) -> tuple[bool, list[str], list[str]]:
        """
...
class ImportManager(Base):
    ...
    def createFusionArchiveImportOptions(self, filename: str) -> FusionArchiveImportOptions:
        ...
        filename : The filename or URL of the Fusion archive file to be imported. Only f3d files can be imported.
...
class Milestones(Base):
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> Milestones:
        return Milestones()
    def __len__(self) -> int:
        return 0
    def __getitem__(self, index: int) -> Milestone:
        return None
    def __iter__(self) -> Iterator[Milestone]:
        return None
    def item(self, index: int) -> Milestone:
        """
        Returns the specified milestone.
        index : The index of the milestone to return. The first milestone in the list has an index of 0.
        Returns the specified file or null if an invalid index was specified.
        """
        return Milestone()
    def itemByName(self, name: str) -> Milestone:
        ...
        """
        return Milestone()
    def asArray(self) -> list[Milestone]:
        """
        Get the current list of all milestones.
        Returns the current list of all milestones.
        """
        return [Milestone()]
    @property
    def count(self) -> int:
...
class Palettes(Base):
    ...
    def add2(self, id: str, name: str, htmlFileURL: str, isVisible: bool, showCloseButton: bool, isResizable: bool, width: int = 200, height: int = 200) -> Palette:
        ...
        """
        return Palette()
    def addTransparent(self, id: str, name: str, htmlFileURL: str, isVisible: bool, showCloseButton: bool, isResizable: bool, isOpaqueWhenUndocked: bool = False, width: int = 200, height: int = 200) -> Palette:
        """
        ...
        showCloseButton : Specifies if a "Close" button should be displayed on the palette to allow the user to easily close it.
        isResizable : Specifies if the palette can be resized by the user or not.
        isOpaqueWhenUndocked : Specifies if the palette will be transparent when docked and opaque when undocked.
        width : Specifies the width of the palette in pixels. If no width is specified a default width will be used.
        height : Specifies the height of the palette in pixels. If no height is specified a default height will be used.
        Returns the newly created palette or null in the case the creation failed.
        """
...
class ProgressBar(Base):
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> ProgressBar:
        return ProgressBar()
    def show(self, message: str, minimumValue: int, maximumValue: int, isModal: bool = False) -> bool:
        """
        ...
        message : Specifies the message that will be displayed in the progress bar. The following symbols can be used to
        ...
        minimumValue : Specifies the minimum value of the progress. This value and the maximum and progress values to compute
        the current percentage complete. This is the initial progress value when the progress bar is first displayed.
        maximumValue : Specifies the maximum value of the progress. This value and the minimum and progress values are
        used to compute the current percentage completion.
        isModal : Specifies if the progress bar should be modal or not. If modal, the progress bar takes over the UI of
        ...
        """
        return bool()
    def showBusy(self, message: str, isModal: bool = False) -> bool:
        """
        ...
        message : Specifies the message that will be displayed in the busy bar. An empty string can be specified if
        you don't want a message and use only the busy meter.
        isModal : Specifies if the busy bar should be modal or not. If modal, the busy bar takes over the UI of
        Fusion, and the user cannot interact with any of the Fusion user interface. You need to be careful when
...
class PropertyGroup(Base):
    ...
    def item(self, index: int) -> Property:
        ...
        index : The index of the property within the group where the first item is 0.
        Returns the specified group or null if an invalid index was specified.
        """
        return Property()
    def itemById(self, id: str) -> Property:
        """
    ...
    def itemByName(self, name: str) -> Property:
        """
        Returns the specified Property using the name of the property.
        name : The name of the property to return. This is the name as seen in the user interface and may be localized.
...
class PropertyGroups(Base):
    ...
    def item(self, index: int) -> PropertyGroup:
        ...
        """
        return PropertyGroup()
    def itemById(self, id: str) -> PropertyGroup:
        """
        ...
        Returns the specified PropertyGroup or null if the ID doesn't match a group within the collection.
        """
        return PropertyGroup()
    def itemByName(self, name: str) -> PropertyGroup:
        """
        Returns the specified PropertyGroup using the name of the group.
        name : The name of the group to return. This is the name as seen in the user interface. Not all groups have a name.
        Returns the specified group or null if the name doesn't match a group within the collection.
        """
        return PropertyGroup()
    @property
    def count(self) -> int:
...
class Script(Base):
    ...
    def unlink(self) -> bool:
        """
        Unlinks this script or add-in. This removes it from Fusion's list of linked scripts and add-ins, so
        it is no longer displayed in the dialog, and if it's an add-in, it will no longer run on startup.
    ...
    def isRunOnStartup(self) -> bool:
        ...
        Fusion is started. This property is only valid when the isAddIn
    ...
    def isFavorite(self, value: bool):
        ...
        pass
    @property
    def location(self) -> ScriptSourceLocations:
        """
        Gets which standard location this script is located.
        """
        return ScriptSourceLocations()
    @property
    def iconFilename(self) -> str:
        """
        Returns the filename of the image file that can be used as the icon for
        this script or add-in. This filename is defined in the manifest of the
        script or add-in using the "iconFilename" setting.
        """
        return str()
    @property
    def appStoreURL(self) -> str:
        """
        For an add-in installed from the Autodesk App Store, this property returns
        the URL on the store for the page of this app. This property returns an empty
        string for all scripts and add-ins not installed from the App Store and if
        there is a problem determining the URL for an App Store app.
        """
        return str()
    @property
    def helpFilename(self) -> str:
        """
        Returns the filename of a local html file that serves as the help file
        for this script or add-in. This filename is defined in the manifest of the
        script or add-in using the "helpFilename" setting.
        """
        return str()
...
class Scripts(Base):
    ...
    def addExisting(self, scriptFolderPath: str) -> Script:
        ...
        """
        return Script()
    def itemsByName(self, name: str) -> list[Script]:
        """
        Function that returns an array of scripts that have the specified name. In most cases this will
        return an array containing a single script, but it's possible to have more than one script
        with the same name in the case where the scripts are in different folders.
        name : The script name to search for.
        Returns the scripts with the specified name or an empty array if there aren't any scripts with that name.
        """
        return [Script()]
    def itemByPath(self, folderPath: str) -> Script:
        """
        Function that returns the script that is located in the specified folder.
        folderPath : The full path to the folder that contains the script. This does not include the name of the script,
        but only the path. For example "C:\Scripts\MyScript" is valid where "C:\Scripts\MyScripts\MyScript.py"
        is not.
        Returns the specified script or null if there isn't a script at the specified path.
        """
        return Script()
    @property
    def count(self) -> int:
...
class SharedLink(Base):
    ...
    def linkURL(self) -> str:
        ...
        return str()
    @property
    def isDownloadAllowed(self) -> bool:
        """
        ...
        """
        return bool()
    @isDownloadAllowed.setter
    def isDownloadAllowed(self, value: bool):
        """
        Specifies if the user with the shared link can download the file or only view it.
        Changing this setting changes the behavior of the existing link. When a DataFile
        is shared, and a link is created, this defaults to true, allowing anyone with the
    ...
    def isPasswordRequired(self, value: bool):
        """
        Gets if a password is required to access the file's web page using the link URL. This
        property can be set to false to turn off the password requirement. It cannot be set
        to true. To enable a password, use the setPassword method, which sets the password
...
class ToolbarControls(Base):
    ...
    def addDropDown(self, text: str, resourceFolder: str, id: str = "", positionID: str = "", isBefore: bool = True) -> DropDownControl:
        ...
        resourceFolder : This argument defines the resource folder that contains the images used for the icon when the drop-down is in a toolbar.
...
class ToolbarTab(Base):
    ...
    def deleteMe(self) -> bool:
        ...
        """
        return bool()
    def move(self, positionId: str, isBefore: bool) -> bool:
        """
        Move this tab to a different position in the Toolbar in the user interface.
        positionId : The ID of another ToolbarTab in the same Toolbar that is used to position this tab. This tab
        will be positioned either directly before or after it.
        isBefore : If true, then this tab will be positioned directly before the tab indicated by positionID. If
...
class UnitsManager(Base):
    ...
    def standardizeExpression(self, expression: str, units: str = "DefaultDistance") -> str:
        ...
        """
        return str()
    def formatValue(self, value: float, units: str = "DefaultDistance", precision: int = -1, showTrailingZeros: BooleanOptions = BooleanOptions.DefaultBooleanOption, minimumPrecision: int = -1, showUnits: bool = True) -> str:
        """
        ...
        value : A floating point value that is assumed to use the internal unit type, which are centimeters for length, radians for angles, and mass is in kilograms.
        units : The units the value represents. The default value for this argument is "DefaultDistance" which means it will
        use the default distance units defined for the active design.
        precision : This specifies the number of decimal places to display. The default value is -1 which indicates the
        precision specified in preferences should be used. A maximum of 9 can be used and any larger numbers
        will be forced to 9.
        showTrailingZeros : Specifies if trailing zeros should be shown or not. The default value is to use the preference setting.
        minimumPrecision : When trailing zeros are not displayed, this specifies a minimum precision where some trailing zeros are
        ...
        showUnits : This specifies whether the unit name or symbol should be included in the result.
        Returns the formatted string or an empty string in case of an error.
        """
        return str()
    @property
...
class UserInterface(Base):
    ...
    @property
    def activeToolbar(self) -> Toolbar:
        """
        Retrieve the active Toolbar being displayed in the user interface.
        """
        return Toolbar()
    @property
    def activeToolbarTab(self) -> ToolbarTab:
        """
    ...
    def isUIEnabled(self) -> bool:
        ...
        return bool()
    @isUIEnabled.setter
    def isUIEnabled(self, value: bool):
        """
        Gets and sets if the Fusion user interface is enabled or not. By default it
        is enabled allowing the user to interact with Fusion. When set to false, the
        UI is disabled which blocks all interaction, including running commands,
...
class CommandControl(ToolbarControl):
    ...
    def cast(arg) -> CommandControl:
        return CommandControl()
    def promote(self, byDefault: bool = False, positionID: str = "", isBefore: bool = True) -> bool:
        """
        Promote the command to the parent panel and optionally position it relative to an already-
        promoted control.
        byDefault : If true, then the control will be promoted in the panel by default if the UI is reset. If
        false, then the promotion is cleared on reset.
        positionID : If provided, then when this control is promoted, it will be positioned in the panel relative
        to the already-promoted control with this ID.
        isBefore : If a positionID is provided, then this specifies whether the promoted control is placed before
        or after the control referenced by the positionID parameter.
        True if this control was successfully promoted or was already promoted. False if promotion
...
class CopyDesignFileInput(CopyFileInput):
    """
    !!!!! Warning !!!!!
    ! This is in preview state; please see the help for more info
    !!!!! Warning !!!!!
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> CopyDesignFileInput:
        return CopyDesignFileInput()
    @property
    def isCopyDrawings(self) -> bool:
        """
        Gets and sets if any drawings associated with the design should also be copied.
        """
        return bool()
    @isCopyDrawings.setter
    def isCopyDrawings(self, value: bool):
        """
        Gets and sets if any drawings associated with the design should also be copied.
        """
        pass
    @property
    def isCopyReferencedExternalComponents(self) -> bool:
        """
        Gets and sets if any external reference components associated with the design should also be copied.
        """
        return bool()
    @isCopyReferencedExternalComponents.setter
    def isCopyReferencedExternalComponents(self, value: bool):
        """
        Gets and sets if any external reference components associated with the design should also be copied.
        """
        pass
...
class HttpEvent(Event):
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> HttpEvent:
        return HttpEvent()
    def add(self, handler: HttpEventHandler) -> bool:
        """
        Add a handler to be notified when the event occurs.
        handler : The handler object to be called when this event is fired.
        Returns true if the addition of the handler was successful.
        """
        return bool()
    def remove(self, handler: HttpEventHandler) -> bool:
        """
        Removes a handler from the event.
        handler : The handler object to be removed from the event.
        Returns true if removal of the handler was successful.
...
class Polyline2D(Curve2D):
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> Polyline2D:
        return Polyline2D()
    @staticmethod
    def create(points: list[Point2D]) -> Polyline2D:
        """
        Creates a transient 2D polyline using an array of Point2D objects that defines
        the position of the polyline vertices.
        points : An array of Point2D objects that define the coordinates of the curve.
        Returns the created Polyline2D object.
        """
        return Polyline2D()
    @staticmethod
    def createByArray(pointCoordinates: list[float]) -> Polyline2D:
        """
        Creates a transient 2D polyline using an array of floating point values that
        specify the X, Y coordinates for each point.
        pointCoordinates : An array of floating point values that define the X, Y coordinates of each
...
class Polyline3D(Curve3D):
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> Polyline3D:
        return Polyline3D()
    @staticmethod
    def create(points: list[Point3D]) -> Polyline3D:
        """
        Creates a transient 3D polyline using an array of Point3D objects that defines
        the position of the polyline vertices.
        points : An array of Point3D objects that define the coordinates of the curve.
        Returns the created Polyline3D object or null if the creation failed.
        """
        return Polyline3D()
    @staticmethod
    def createByArray(pointCoordinates: list[float]) -> Polyline3D:
        """
        Creates a transient 3D polyline using an array of floating point values that
        specify the X, Y, Z coordinates for each point.
        pointCoordinates : An array of floating point values that define the X, Y, Z coordinates of each
        point in the polyline.
        Returns the created Polyline3D object or null if the creation failed
        """
        return Polyline3D()
    ...
    def points(self) -> list[Point3D]:
        ...
        return [Point3D()]
    @points.setter
    def points(self, value: list[Point3D]):
        """
        Gets and sets the points that define the coordinates of the polyline.
        """
        pass
...
class SelectionCommandInput(CommandInput):
    ...
    def hasFocus(self, value: bool):
        ...
        pass
    @property
    def isUseCurrentSelections(self) -> bool:
        """
        !!!!! Warning !!!!!
        ! This is in preview state; please see the help for more info
        !!!!! Warning !!!!!
        ...
        """
        return bool()
    @isUseCurrentSelections.setter
    def isUseCurrentSelections(self, value: bool):
        """
        !!!!! Warning !!!!!
        ! This is in preview state; please see the help for more info
        !!!!! Warning !!!!!
...
class SeparatorCommandInput(CommandInput):
    """
    ...
    def __init__(self):
        pass
    @staticmethod
    def cast(arg) -> SeparatorCommandInput:
        return SeparatorCommandInput()
